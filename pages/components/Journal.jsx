  ...
  return (
      <div className="flex flex-col p-6 border-gray-200">
        ...
        <table className="border-collapse border border-gray-400">
            <thead>
                <tr>
                    <th className="border border-gray-300 text-center w-1/2" colSpan={2}>INCOMING</th>
                    <th className="border border-gray-300 text-center w-1/2" colSpan={2}>OUTGOING</th>
                </tr>
            </thead>
            <tbody>
